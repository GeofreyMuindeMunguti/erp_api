# Generated by Django 2.2.1 on 2019-06-17 18:44
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('po_steel_cost', models.CharField(blank=True, choices=[('10000', '10000'), ('20000', '20000'), ('30000', '30000'), ('40000', '40000')], default='None', max_length=120)),
                ('po_electrical_materials', models.FileField(blank=True, null=True, upload_to='files/ProcurementTeam/poelectrical/%Y/%m/%d/')),
                ('po_electrical_materials_cost', models.CharField(blank=True, choices=[('10000', '10000'), ('20000', '20000'), ('30000', '30000'), ('40000', '40000')], default='None', max_length=120)),
                ('po_subcontractors', models.FileField(blank=True, null=True, upload_to='files/ProcurementTeam/posubcontractor/%Y/%m/%d/')),
                ('po_subcontractors_cost', models.CharField(blank=True, choices=[('10000', '10000'), ('20000', '20000'), ('30000', '30000'), ('40000', '40000')], default='None', max_length=120)),
                ('is_approved', models.BooleanField(default=False)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('is_active', models.BooleanField(default=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('concrete_pour_curing', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='erp_construction.ConcretePourImage')),
                ('concrete_pour_period', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='erp_construction.ConcreteCuringPeriodImage')),
                ('engineers_atsite', models.ManyToManyField(to='users.Engineer')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('health_documents', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='erp_construction.HealthDocumentsCivilTeam')),
                ('posted_by', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='users.CustomUser')),
                ('project_name', models.OneToOneField(on_delete=django.db.models.deletion.DO_NOTHING, to='erp_construction.Project')),
