# Generated by Django 2.2.1 on 2019-06-17 08:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('is_active', models.BooleanField(default=True)),
                ('access_approval', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='erp_construction.AccessApprovalCivil')),
                ('posted_by', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='users.CustomUser')),
