    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('po_steel_cost', models.CharField(blank=True, max_length=100, null=True)),
                ('po_electrical_materials', models.FileField(blank=True, null=True, upload_to='files/ProcurementTeam/poelectrical/%Y/%m/%d/')),
                ('po_electrical_materials_cost', models.CharField(blank=True, max_length=100, null=True)),
                ('po_subcontractors', models.FileField(blank=True, null=True, upload_to='files/ProcurementTeam/posubcontractor/%Y/%m/%d/')),
                ('po_subcontractors_cost', models.CharField(blank=True, max_length=100, null=True)),
                ('is_approved', models.BooleanField(default=False)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('is_active', models.BooleanField(default=True)),
