    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_date', models.DateTimeField(blank=True, null=True)),
                ('end_date', models.DateTimeField(blank=True, null=True)),
                ('underground_ducting_and_manholes_image_1', models.ImageField(blank=True, null=True, upload_to='images/InstallationTeam/Electrical/UndergroundTask/%Y/%m/%d/')),
                ('underground_ducting_and_manholes_image_2', models.ImageField(blank=True, null=True, upload_to='images/InstallationTeam/Electrical/UndergroundTask/%Y/%m/%d/')),
                ('underground_ducting_and_manholes_image_3', models.ImageField(blank=True, null=True, upload_to='images/InstallationTeam/Electrical/UndergroundTask/%Y/%m/%d/')),
