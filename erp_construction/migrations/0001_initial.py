# Generated by Django 2.2.1 on 2019-06-02 16:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('is_active', models.BooleanField(default=True)),
                ('block_construction', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='erp_construction.BlockworkPanelConstImage')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('is_active', models.BooleanField(default=True)),
                ('antenna_coax_installation', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='erp_construction.AntennaCoaxInstallImage')),
                ('cable_ways', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='erp_construction.CableWaysImage')),
                ('engineers_atsite', models.ManyToManyField(to='users.Engineer')),
                ('project_name', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='erp_construction.Project')),
                ('tower_erection', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='erp_construction.TowerErectionImage')),
                ('tower_painting', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='erp_construction.TowerPaintImage')),
            ],
        ),
        migrations.CreateModel(
            name='TelecomTasks',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rf_document', models.FileField(blank=True, null=True, upload_to='files/SafaricomTeam/rf/%Y/%m/%d/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('posted_by', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='users.CustomUser')),
                ('project_name', models.OneToOneField(on_delete=django.db.models.deletion.DO_NOTHING, to='erp_construction.Project')),
                ('site_walling_images_field', models.OneToOneField(on_delete=django.db.models.deletion.DO_NOTHING, to='erp_construction.BoundaryWallImage')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='erp_construction.ConcretePourCuringPeriodImage'),
        ),
        migrations.AddField(
            model_name='btsandgeneatorslabsimage',
            name='engineers_atsite',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='erp_construction.ExcavationImage'),
        ),
        migrations.AddField(
            model_name='btsandgeneatorslabsimage',
            name='project_name',
        ...
        migrations.AddField(
            ...
            name='foundation_foot_pouring',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='erp_construction.FoundFootPourImage'),
        ),
        migrations.AddField(
            model_name='boundarywallimage',
            name='gate_installation',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='erp_construction.GateInstallationImage'),
        ),
        migrations.AddField(
            model_name='boundarywallimage',
            name='project_name',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='erp_construction.RazorElectricFenceImage'),
        ),
        migrations.AddField(
