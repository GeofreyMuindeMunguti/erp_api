# Generated by Django 2.2.1 on 2019-09-30 16:35
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('geotech_file_comment', models.CharField(blank=True, max_length=100, null=True)),
                ...
                ('rof_8', models.FileField(blank=True, null=True, upload_to='files/Project/rof8s/%Y/%m/%d/')),
                ('rof_8_comment', models.CharField(blank=True, max_length=100, null=True)),
                ('sign_off', models.FileField(blank=True, null=True, upload_to='files/Project/signoffs/%Y/%m/%d/')),
                ('sign_off_comment', models.CharField(blank=True, max_length=100, null=True)),
                ('rfi', models.FileField(blank=True, null=True, upload_to='files/Project/rfis/%Y/%m/%d/')),
                ('rfi_comment', models.CharField(blank=True, max_length=100, null=True)),
                ('integration_parameter', models.FileField(blank=True, null=True, upload_to='files/Project/integrationparameters/%Y/%m/%d/')),
                ('integration_parameter_comment', models.CharField(blank=True, max_length=100, null=True)),
                ('ip_plan', models.FileField(blank=True, null=True, upload_to='files/Project/ipplans/%Y/%m/%d/')),
                ('ip_plan_comment', models.FileField(blank=True, null=True, upload_to='files/Project/ipplans/%Y/%m/%d/')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='FabricationQualityInspectionImage',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ...
                ('fabrication_quality_inspection_image_comment', models.CharField(blank=True, max_length=100, null=True)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_date', models.DateTimeField()),
                ('end_date', models.DateTimeField(blank=True, null=True)),
                ('fabrication_rooftop_image_comment', models.CharField(blank=True, max_length=100, null=True)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            name='FabricationSteelDeckImage',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ...
                ('fabrication_steel_deck_image_comment', models.CharField(blank=True, max_length=100, null=True)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('galvanisation_image_comment', models.CharField(blank=True, max_length=100, null=True)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tower_complete_comment', models.CharField(blank=True, max_length=100, null=True)),
                ('free_issue_material', models.FileField(blank=True, null=True, upload_to='files/IRROF7Frees/freeissuematerials/%Y/%m/%d/')),
                ('free_issue_material_comment', models.CharField(blank=True, max_length=100, null=True)),
                ('link_material', models.FileField(blank=True, null=True, upload_to='files/IRROF7Frees/linkmaterials/%Y/%m/%d/')),
                ('link_material_comment', models.CharField(blank=True, max_length=100, null=True)),
                ('is_approved', models.BooleanField(default=False)),
            ],
            options={
                'abstract': False,
