    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('is_active', models.BooleanField(default=True)),
                ('blinding_image', models.ImageField(blank=True, null=True, upload_to='images/CivilWorksTeam/Blinding/%Y/%m/%d/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_active', models.BooleanField(default=True)),
                ('work_day', models.DateField(blank=True, null=True)),
                ('casuals_list', models.FileField(blank=True, null=True, upload_to='files/bts/Casuals/SetSiteClearing/%Y/%m/%d/')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_active', models.BooleanField(default=True)),
                ('work_day', models.DateField(blank=True, null=True)),
                ('casuals_list', models.FileField(blank=True, null=True, upload_to='files/bts/Casuals/SteelFixFormworkImage/%Y/%m/%d/')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('is_active', models.BooleanField(default=True)),
                ('setting_site_clearing_image', models.ImageField(blank=True, null=True, upload_to='images/CivilWorksTeam/siteclearing/%Y/%m/%d/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_date', models.DateTimeField(blank=True, null=True)),
                ('end_date', models.DateTimeField(blank=True, null=True)),
                ('setting_site_clearing_image_1', models.ImageField(blank=True, null=True, upload_to='images/CivilWorksTeam/siteclearing/%Y/%m/%d/')),
                ('setting_site_clearing_image_2', models.ImageField(blank=True, null=True, upload_to='images/CivilWorksTeam/siteclearing/%Y/%m/%d/')),
                ('setting_site_clearing_image_3', models.ImageField(blank=True, null=True, upload_to='images/CivilWorksTeam/siteclearing/%Y/%m/%d/')),
                ('setting_site_clearing_comment', models.CharField(blank=True, max_length=100, null=True)),
            ],
            options={
                'abstract': False,
        ...
        migrations.CreateModel(
            name='SteelFixFormworkImageS',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('is_active', models.BooleanField(default=True)),
                ('steel_fixformwork_image', models.ImageField(blank=True, null=True, upload_to='images/CivilWorksTeam/Blinding/%Y/%m/%d/')),
                ('steel_fixformwork_image_comment', models.CharField(blank=True, max_length=100, null=True)),
            ],
            options={
                'abstract': False,
            },
