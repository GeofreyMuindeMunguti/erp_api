...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='fabricationsteeldeckimage',
            name='project_name',
            field=models.OneToOneField(on_delete=django.db.models.deletion.DO_NOTHING, to='erp_construction.BtsSite'),
        ),
        migrations.AddField(
            model_name='fabricationrooftopimage',
            name='fabrication_quality_inspection_image',
            field=models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='erp_construction.FabricationQualityInspectionImage'),
        ),
        migrations.AddField(
            model_name='fabricationrooftopimage',
            name='fabrication_steel_deck_image',
            field=models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='erp_construction.FabricationSteelDeckImage'),
        ),
        migrations.AddField(
            model_name='fabricationrooftopimage',
            name='galvanization_image',
            field=models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='erp_construction.GalvanisationImage'),
        ),
        migrations.AddField(
            model_name='fabricationrooftopimage',
            name='project_name',
        ...
        migrations.AddField(
            model_name='fabricationqualityinspectionimage',
            name='project_name',
            field=models.OneToOneField(on_delete=django.db.models.deletion.DO_NOTHING, to='erp_construction.BtsSite'),
        ),
        migrations.AddField(
