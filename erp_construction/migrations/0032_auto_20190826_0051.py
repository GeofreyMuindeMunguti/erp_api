# Generated by Django 2.2.1 on 2019-08-25 21:51
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('users', '0001_initial'),
        ('erp_construction', '0031_auto_20190825_2343'),
    ]

    operations = [
        migrations.RenameModel(
            old_name='BS241AndGeneatorSlabTask',
            new_name='BS241AndGeneratorSlabTask',
        ),
        migrations.AlterModelOptions(
            name='bs241andgeneratorslabtask',
            options={'verbose_name': 'BS241 and GENERATOR SLAB TASK'},
        ),
        migrations.AlterModelOptions(
            name='foundationcreationtask',
            options={'verbose_name': 'FOUNDATION CREATION TASK'},
        ),
