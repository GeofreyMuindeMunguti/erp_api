...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='daily_tower_base',
            field=models.OneToOneField(on_delete=django.db.models.deletion.DO_NOTHING, to='erp_construction.DailyTowerBase'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='project_name',
            field=models.OneToOneField(on_delete=django.db.models.deletion.DO_NOTHING, to='erp_construction.DailySteelFixFormwork'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='daily_site_clearing',
            field=models.OneToOneField(on_delete=django.db.models.deletion.DO_NOTHING, to='erp_construction.DailySiteClearing'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='issues',
            name='project_name',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='issuess', to='erp_construction.BtsSite'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='binding',
            field=models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='erp_construction.SiteBlindingSubTask'),
        ),
        migrations.AddField(
            model_name='foundationimage',
        ...
        migrations.AddField(
            model_name='dailytowerbase',
            name='no_of_casuals_atsite',
            field=models.ManyToManyField(blank=True, to='users.Casual'),
        ),
        migrations.AddField(
            model_name='dailytowerbase',
            name='tower_base_subtask',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='erp_construction.TowerBaseSubTask'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='dailysteelfixformwork',
            name='project_name',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='erp_construction.SteelFixFormworkImage'),
        ),
        migrations.AddField(
            model_name='dailysiteclearing',
            name='no_of_casuals_atsite',
            field=models.ManyToManyField(blank=True, to='users.Casual'),
        ),
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='erp_construction.SiteClearingSubTask'),
        ),
        migrations.AddField(
            model_name='dailyblinding',
            name='no_of_casuals_atsite',
            field=models.ManyToManyField(blank=True, to='users.Casual'),
        ),
        migrations.AddField(
            model_name='dailyblinding',
            name='project_name',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='erp_construction.SiteBlindingSubTask'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='project_name',
            field=models.OneToOneField(on_delete=django.db.models.deletion.DO_NOTHING, to='erp_construction.DailyBlinding'),
        ),
        migrations.AddField(
