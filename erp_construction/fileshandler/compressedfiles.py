...
#     def make_tarfile(self,output_filename, source_dir): ##repeated function /need its own class
#         import tarfile
...
#             pass
#             #TO DO :::Resolve this issue //"http://127.0.0.1:8001/Images does not exist"

        
#         # TO DO : Find a better way to address issues// Can on DEV /Debug=True
#         compressed_project_files = 'http://127.0.0.1:8001/{}'.format(cfile)   ##Hard Coded URLs for testing/Development
#         compressed_project_images = 'http://127.0.0.1:8001/{}'.format(cmage)   ##Hard Coded URLs for testing/Development
...
#         # TO DO : Find a better way to address issues// Can on DEV /Debug=True
#         compressed_project_files = 'http://127.0.0.1:8001/{}'.format(efile)   ##Hard Coded URLs for testing/Development
#         compressed_project_images = 'http://127.0.0.1:8001/{}'.format(emage)   ##Hard Coded URLs for testing/Development
