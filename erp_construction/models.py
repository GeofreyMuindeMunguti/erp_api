...
class CivilWorksTeam(models.Model):
    ...
    health_documents_comment = ArrayField(models.CharField(max_length=100, blank=True, null=True))
    ...
    bts_and_generator_slabs_images = models.ManyToManyField(BTSAndGeneatorSlabsImage)
