...
class UserAdmin(admin.ModelAdmin):
    list_display = ('id', 'employee_id', 'password', 'created_at', 'updated_at', 'is_active')
...
class ProjectAdmin(admin.ModelAdmin):
    list_display = ('id', 'project_name', 'geotech_file', 'access_letter', 'approved_drawing', 'location', 'created_by', 'created_at', 'updated_at', 'is_active')
...
class AccessApprovalCivilAdmin(admin.ModelAdmin):
    list_display = ('id', 'project_name', 'access_approval', 'created_at', 'updated_at', 'is_active')
    list_display_links = ('project_name', )
    search_fields = ('project_name', )
    list_editable = ('is_active',)
...
class CommercialTeamAdmin(admin.ModelAdmin):
    list_display = ('id', 'project_name', 'po_file', 'po_file_comment', 'initial_invoice', 'initial_invoice_comment', 'posted_by', 'is_approved', 'created_at', 'updated_at', 'is_active')
    list_display_links = ('project_name', )
...
class ProcurementTeamAdmin(admin.ModelAdmin):
    list_display = ('id', 'project_name', 'po_steel', 'po_steel_comment', 'po_electrical_materials', 'po_electrical_materials_comment', 'po_subcontractors', 'po_subcontractors_comment', 'posted_by', 'is_approved', 'created_at', 'updated_at', 'is_active')
    list_display_links = ('project_name', )
    list_filter = ('project_name',)
    search_fields = ('project_name', )
    list_editable = ('is_active',)
...
class HealthDocumentsCivilTeamAdmin(admin.ModelAdmin):
    list_display = ('id', 'project_name', 'job_hazard_form', 'job_hazard_form_comment', 'incident_notification_form', 'incident_notification_form_comment', 'toolbox_meeting_form', 'toolbox_meeting_form_comment', 'communication_plan_form', 'communication_plan_form_comment', 'posted_by', 'is_approved', 'created_at', 'updated_at', 'is_active')
    list_display_links = ('project_name', )
    list_filter = ('project_name',)
    search_fields = ('project_name', )
    list_editable = ('is_active',)
...
class FoundationImageAdmin(admin.ModelAdmin):
    list_display = ('id', 'project_name', 'foundation_and_curing_image', 'created_at', 'updated_at', 'is_active')
    list_display_links = ('project_name', )
    list_filter = ('project_name',)
    search_fields = ('project_name', )
    list_editable = ('is_active',)
...
class BTSAndGeneatorSlabsImageAdmin(admin.ModelAdmin):
    list_display = ('id', 'project_name', 'bts_and_generator_slabs_image', 'created_at', 'updated_at', 'is_active')
    list_display_links = ('project_name', )
    list_filter = ('project_name',)
    search_fields = ('project_name', )
    list_editable = ('is_active',)
...
class SiteWallingImageAdmin(admin.ModelAdmin):
    list_display = ('id', 'project_name', 'site_walling_image', 'created_at', 'updated_at', 'is_active')
    list_display_links = ('project_name', )
    list_filter = ('project_name',)
    search_fields = ('project_name', )
    list_editable = ('is_active',)
...
class RFAndLinkImageAdmin(admin.ModelAdmin):
    list_display = ('id', 'project_name', 'rf_and_link_installation_image', 'created_at', 'updated_at', 'is_active')
    list_display_links = ('project_name', )
    list_filter = ('project_name',)
    search_fields = ('project_name', )
    list_editable = ('is_active',)
...
class ElectricalImageAdmin(admin.ModelAdmin):
    list_display = ('id', 'project_name', 'electrical_installation_image', 'created_at', 'updated_at', 'is_active')
    list_display_links = ('project_name', )
    list_filter = ('project_name',)
    search_fields = ('project_name', )
    list_editable = ('is_active',)
...
class KPLCSolarImageAdmin(admin.ModelAdmin):
    list_display = ('id', 'project_name', 'kplc_solar_installation_image', 'created_at', 'updated_at', 'is_active')
    list_display_links = ('project_name', )
    list_filter = ('project_name',)
    search_fields = ('project_name', )
    list_editable = ('is_active',)
...
class CivilWorksTeamAdmin(admin.ModelAdmin):
    list_display = ('id', 'project_name', 'health_documents_civil', 'health_documents_comment', 'access_approvals', 'access_approval_comment', 'foundation_images', 'foundation_and_curing_comment', 'slabs_images', 'bts_and_generator_slabs_comment', 'site_walling_images', 'site_walling_images_comment', 'posted_by', 'is_approved', 'created_at', 'updated_at', 'is_active')
    list_display_links = ('project_name', )
    list_filter = ('project_name',)
    search_fields = ('project_name', )
    list_editable = ('is_active',)
...
class InstallationTeamAdmin(admin.ModelAdmin):
    list_display = ('id', 'project_name', 'health_documents_installation', 'health_documents_comment', 'access_approvals', 'access_approval_comment', 'rf_and_link_images', 'rf_and_link_installation_comment', 'electrical_connections_images', 'electrical_installation_comment', 'kplc_solar_images', 'kplc_solar_installation_comment', 'posted_by', 'is_approved', 'created_at', 'updated_at', 'is_active')
    list_display_links = ('project_name', )
    list_filter = ('project_name',)
    search_fields = ('project_name', )
    list_editable = ('is_active',)
