# Generated by Django 2.2.1 on 2019-08-20 13:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('no_of_casuals_atsite', models.ManyToManyField(blank=True, to='users.Casual')),
                ('posted_by', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='users.CustomUser')),
                ('site_name', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='sitepoleinstallations', to='erp_ftts.FttsSite')),
            ],
            options={
                'abstract': False,
            },
