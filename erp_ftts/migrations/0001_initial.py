    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ftts_po_requisition', models.FileField(blank=True, null=True, upload_to=erp_core.fileshandler.filemixin.UploadToProjectDir('FTTSProjects', 'files/CommercialTeam/requisition/'))),
                ...
                ('ftts_wayleave_application', models.FileField(blank=True, null=True, upload_to=erp_core.fileshandler.filemixin.UploadToProjectDir('FTTSProjects', 'files/CommercialTeam/wayleaveapplication/'))),
                ('ftts_project_plan', models.FileField(blank=True, null=True, upload_to=erp_core.fileshandler.filemixin.UploadToProjectDir('FTTSProjects', 'files/CommercialTeam/projectplan/'))),
                ('ftts_initial_invoice', models.FileField(blank=True, null=True, upload_to=erp_core.fileshandler.filemixin.UploadToProjectDir('FTTSProjects', 'files/CommercialTeam/initialinvoice/'))),
                ('ftts_po_client', models.FileField(blank=True, null=True, upload_to=erp_core.fileshandler.filemixin.UploadToProjectDir('FTTSProjects', 'files/CommercialTeam/poclient/'))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('snag_document', models.FileField(blank=True, null=True, upload_to=erp_core.fileshandler.filemixin.UploadToProjectDirSubTask('FTTSProjects', 'files/SafaricomTeamftts/snag/'))),
                ('snag_document_comment', models.CharField(blank=True, max_length=100, null=True)),
                ('conditional_acceptance_cert', models.FileField(blank=True, null=True, upload_to=erp_core.fileshandler.filemixin.UploadToProjectDirSubTask('FTTSProjects', 'files/SafaricomTeamftts/conditionalcert/'))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('site_trenching_comment', models.CharField(blank=True, max_length=100, null=True)),
                ('site_name', models.OneToOneField(on_delete=django.db.models.deletion.DO_NOTHING, related_name='sitetrenching', to='erp_ftts.FttsSite')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('interception_comment', models.CharField(blank=True, max_length=100, null=True)),
                ('day_image', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='interceptionimages', to='erp_ftts.DailySiteInterception')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('site_name', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='siteinterception', to='erp_ftts.FttsSite')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('site_duct_comment', models.CharField(blank=True, max_length=100, null=True)),
                ('day_image', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='ductimages', to='erp_ftts.DailySiteDuctInstallation')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('site_name', models.OneToOneField(on_delete=django.db.models.deletion.DO_NOTHING, related_name='siteductinstallation', to='erp_ftts.FttsSite')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cable_comment', models.CharField(blank=True, max_length=100, null=True)),
                ('day_image', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='cableimages', to='erp_ftts.DailySiteCableInstallation')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('site_name', models.OneToOneField(on_delete=django.db.models.deletion.DO_NOTHING, related_name='sitecableinstallation', to='erp_ftts.FttsSite')),
            ],
            options={
                'abstract': False,
            },
