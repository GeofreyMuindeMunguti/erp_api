    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ftts_homepass_acceptance_cert', models.FileField(blank=True, null=True, upload_to=erp_core.fileshandler.filemixin.UploadToProjectDir('FTTSProjects', 'files/SafaricomTeamftts/opsacceptance/'))),
                ('ftts_homepass_acceptance_cert_comment', models.CharField(blank=True, max_length=100, null=True)),
