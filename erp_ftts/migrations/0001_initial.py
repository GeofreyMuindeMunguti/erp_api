# Generated by Django 2.2.1 on 2019-08-22 11:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('is_active', models.BooleanField(default=True)),
                ('daily_image_1', models.ImageField(blank=True, null=True, upload_to='images/ftts/dailytasks/%Y/%m/%d/')),
                ('daily_image_2', models.ImageField(blank=True, null=True, upload_to='images/ftts/dailytasks/%Y/%m/%d/')),
                ('daily_image_3', models.ImageField(blank=True, null=True, upload_to='images/ftts/dailytasks/%Y/%m/%d/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('task_days', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='erp_ftts.FttsDailyTasks')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='fttsinstallationteam',
            name='task_days',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='erp_ftts.FttsDailyTasks'),
        ),
        migrations.AddField(
            model_name='fttsdailytasks',
            name='site_name',
