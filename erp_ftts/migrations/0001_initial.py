    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ftts_final_acceptance_cert', models.FileField(blank=True, null=True, upload_to='files/SafaricomTeamftts/finalcert/%Y/%m/%d/')),
                ...
                ('site_name', models.ManyToManyField(blank=True, related_name='fttsprojects', to='erp_core.MainSite')),
            ],
            options={
                'ordering': ('-created_at',),
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('manhole', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='erp_ftts.ManHole')),
                ('posted_by', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='users.CustomUser')),
                ('project_name', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='erp_ftts.FTTSProject')),
                ('site_name', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='erp_core.MainSite')),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_active', models.BooleanField(default=True)),
                ('posted_by', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='users.CustomUser')),
                ('site_name', models.OneToOneField(on_delete=django.db.models.deletion.DO_NOTHING, to='erp_core.MainSite')),
            ],
        ),
        migrations.CreateModel(
            name='fttsSurvey',
            fields=[
                ...
                ('ftth_interception_point', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='erp_ftts.InterceptionPoint')),
                ('posted_by', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='users.CustomUser')),
                ('site_name', models.OneToOneField(on_delete=django.db.models.deletion.DO_NOTHING, to='erp_core.MainSite')),
                ('survey_photos', models.ManyToManyField(to='erp_ftts.fttsSurveyPhotos')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_approved', models.BooleanField(default=False)),
                ('ftts_inception', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='erp_ftts.SiteInterception')),
                ('ftts_integration', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='erp_ftts.SiteIntegration')),
                ('ftts_issues', models.ManyToManyField(blank=True, to='erp_ftts.FttsIssues')),
                ('ftts_terminal_in_hse', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='erp_ftts.SiteTerminalInHse')),
                ('posted_by', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='users.CustomUser')),
                ('project_name', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='erp_ftts.FTTSProject')),
                ('site_name', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='erp_core.MainSite')),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_approved', models.BooleanField(default=False)),
                ('ftts_backfiling', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='erp_ftts.SiteBackfilling')),
                ...
                ('ftts_pole_installation', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='erp_ftts.SitePoleInstallation')),
