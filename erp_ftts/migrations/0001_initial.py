    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('site_trenching_comment', models.CharField(blank=True, max_length=100, null=True)),
                ('day_image', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='trenchingimage', to='erp_ftts.DailySiteTrenching')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('terminal_comment', models.CharField(blank=True, max_length=100, null=True)),
                ('day_image', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='terminalinhseimage', to='erp_ftts.DailySiteTerminalInHse')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('interception_comment', models.CharField(blank=True, max_length=100, null=True)),
                ('day_image', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='interceptionimage', to='erp_ftts.DailySiteInterception')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('site_duct_comment', models.CharField(blank=True, max_length=100, null=True)),
                ('day_image', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='ductimage', to='erp_ftts.DailySiteDuctInstallation')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cable_comment', models.CharField(blank=True, max_length=100, null=True)),
                ('day_image', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='cableimage', to='erp_ftts.DailySiteCableInstallation')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('manhole_comment', models.CharField(blank=True, max_length=100, null=True)),
                ('day_image', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='manholeimage', to='erp_ftts.DailyManHoleInstallation')),
            ],
            options={
                'abstract': False,
            },
