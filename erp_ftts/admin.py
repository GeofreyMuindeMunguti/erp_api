...
class FttsProcurementTeamAdmin(admin.ModelAdmin):
    list_display = ('id','site_name', 'ftts_material_requisition','ftts_po_quote_serviceno','ffts_po_quote_serviceamount', 'ftts_po_subcontractors', 'ffts_po_quote_subconamount','ffts_po_quote_subconno','posted_by', 'created_at', 'updated_at', 'is_active')
    list_display_links = ('site_name', )
    search_fields = ('site_name', )
    list_editable = ('is_active',)
