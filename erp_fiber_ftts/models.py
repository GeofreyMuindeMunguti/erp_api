...
class SitePoleInstallation(TimeStampModel,TimeTrackModel):
    site_name = models.OneToOneField(Site, on_delete=models.DO_NOTHING,blank=True, null=True)
    project_name = models.ForeignKey(FTTSProject, on_delete=models.DO_NOTHING,blank=True, null=True)
    site_pole_installation_image_1 = models.ImageField(upload_to='images/ftts/CivilWorksTeam/poleinstallation/%Y/%m/%d/',blank=True, null=True)
    site_pole_installation_image_2 = models.ImageField(upload_to='images/ftts/CivilWorksTeam/poleinstallation/%Y/%m/%d/',blank=True, null=True)
    site_pole_installation_image_3 = models.ImageField(upload_to='images/ftts/CivilWorksTeam/poleinstallation/%Y/%m/%d/',blank=True, null=True)
...
class SiteTrenching(TimeStampModel,TimeTrackModel):
    site_name = models.OneToOneField(Site, on_delete=models.DO_NOTHING,blank=True, null=True)
    project_name = models.ForeignKey(FTTSProject, on_delete=models.DO_NOTHING,blank=True, null=True)
    site_trenching_image_1 = models.ImageField(upload_to='images/ftts/CivilWorksTeam/trenching/%Y/%m/%d/',blank=True, null=True) #NOT blank
...
class SiteTerminalInHse(TimeStampModel,TimeTrackModel):
    site_name = models.OneToOneField(Site, on_delete=models.DO_NOTHING,blank=True, null=True)
    project_name = models.ForeignKey(FTTSProject, on_delete=models.DO_NOTHING,blank=True, null=True)
    site_terminal_in_hse_image_1 = models.ImageField(upload_to='images/ftts/InstallationTeam/terminalinhse/%Y/%m/%d/',blank=True, null=True)
    site_terminal_in_hse_image_2 = models.ImageField(upload_to='images/ftts/InstallationTeam/terminalinhse/%Y/%m/%d/',blank=True, null=True)
    site_terminal_in_hse_image_3 = models.ImageField(upload_to='images/ftts/InstallationTeam/terminalinhse/%Y/%m/%d/',blank=True, null=True)
...
class SiteInterception(TimeStampModel,TimeTrackModel):
    site_name = models.OneToOneField(Site, on_delete=models.DO_NOTHING,blank=True, null=True)
    project_name = models.ForeignKey(FTTSProject, on_delete=models.DO_NOTHING,blank=True, null=True)
    site_inception_image_1 = models.ImageField(upload_to='images/ftts/InstallationTeam/inception/%Y/%m/%d/',blank=True, null=True)
    site_inception_image_2 = models.ImageField(upload_to='images/ftts/InstallationTeam/inception/%Y/%m/%d/',blank=True, null=True)
    site_inception_image_3 = models.ImageField(upload_to='images/ftts/InstallationTeam/inception/%Y/%m/%d/',blank=True, null=True)
...
class SiteIntegration(TimeStampModel,TimeTrackModel):
    site_name = models.OneToOneField(Site, on_delete=models.DO_NOTHING,blank=True, null=True)
    project_name = models.ForeignKey(FTTSProject, on_delete=models.DO_NOTHING,blank=True, null=True)
    site_integration_image_1 = models.ImageField(upload_to='images/ftts/InstallationTeam/integration/%Y/%m/%d/',blank=True, null=True)
    site_integration_image_2 = models.ImageField(upload_to='images/ftts/InstallationTeam/integration/%Y/%m/%d/',blank=True, null=True)
    site_integration_image_3 = models.ImageField(upload_to='images/ftts/InstallationTeam/integration/%Y/%m/%d/',blank=True, null=True)
