...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='projectteamftts',
            name='team_member_type',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='users.TeamMemberType'),
        ),
        migrations.AddField(
            model_name='projectteamftth',
            name='team_member_type',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='users.TeamMemberType'),
        ),
        migrations.AddField(
